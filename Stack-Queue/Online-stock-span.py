...
# TC = 0(N) - total no. of days
# SC = 0(N) - total no. of next call till now
...
# This stack-based approach ensures that the time complexity for each call to next() is amortized O(1) on average
